...
var ConnectModal = function (_a) {
    var login = _a.login, network = _a.network, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss }, connectors.map(function (entry, index) { return entry.network.find(function (ele) { return ele === network; }) ? (React.createElement(WalletCard, { key: entry.title, login: login, walletConfig: entry, onDismiss: onDismiss, mb: index < connectors.length - 1 ? "8px" : "0" })) : ''; })));
};
...
var useWalletModal = function (login, logout, account, network) {
    var onPresentConnectModal = useModal(React.createElement(ConnectModal, { login: login, network: network || 56 }))[0];
...
var templateObject_1$L, templateObject_2$i, templateObject_3$9, templateObject_4$4, templateObject_5$3;
